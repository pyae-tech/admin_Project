<%@ Page Title="" Language="C#" MasterPageFile="~/PortalAdministration/userInterfaces/moduleSystem/masterFiles/FullFrameMaster.Master" AutoEventWireup="true" CodeBehind="pageSystemOrganization.aspx.cs" Inherits="SBSPortal3.PortalAdministration.userInterfaces.moduleSystem.systemOrganization.pageSystemOrganization" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Header" runat="server">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <button class="btn btn-dark  btn-rounded  btn-labeled" type="button" onclick="NewOrganization();return false;"><i class="btn-label ion-plus-round"></i><span class="bold">New</span></button>
    </ol>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End breadcrumb-->
                ...
                <div class="panel">
                    <div class="tabs-container" id="tab-main">
                        ...
                        <div class="panel-heading">
                            ...
                            <h3><i class="ion-ionic"></i>System Organizations</h3>
                        </div>
                                ...
                                <div class="tab-pane fade in " id="tab-list">
                                    ...
                                    <table style="display: none">
                                        <tbody id="template_row">
                                            <tr style="cursor: pointer;" onclick="GetOrganization('[OrgID]');return false;">
                                                <td>[OrgName]</td>
                                                <td>[OrgCode]</td>
                                                <td>[UserCount]</td>
                                                <td>[OrgPlan]</td>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_JS" runat="server">
    <script src='<%= ResolveUrl("pageSystemOrganization.js")%>'></script>
</asp:Content>
