(function() {
    ...
    DXDemo.recalculateDemoSettingsColumnWidth = function() {
        if(typeof(ASPxClientFormLayout) === "undefined") return;
        ASPxClientControl.GetControlCollection()
            .GetControlsByType(ASPxClientFormLayout)
            .forEach(function(formLayout) {
                formLayout.GetAdaptiveColumnLayoutHelper().RecalculateLayout();
            });
    };
    ...
    DXDemo.adjustDemoSettingsBlock = function() {
        ...
        // TODO: remove when bug with column recalculation will be fixed
        DXDemo.recalculateDemoSettingsColumnWidth();
    }
