  ...
  ImagePickerOption = function () {
    ...
    _createClass(ImagePickerOption, [{
      ...
      value: function create_node() {
          var image, imgAlt, imgClass, thumbnail, deleteImage, deletefunction;
        this.node = jQuery("<li/>");
        ...
        if (this.option.data("font_awesome")) {
          ...
          image.attr("class", "fa-fw " + this.option.data("img-src"));
            ...
            image = jQuery("<img class='image_picker_image img_thumb'/>");

            var start = this.option.data("img-src").length - 3;
            var res = this.option.data("img-src").substr(start, 3);
            if (res == "pdf") {
                var openfile = "OpenAttachment('" + this.option.data('img-src') + "')";
                image.attr("src", "https://www.bandaryae.com/PortalAdministration/img/pdf-icon.png");
                image.attr("onclick", openfile);
            }
            else {
                image.attr("src", this.option.data("img-src"));
                //image.attr("onclick", "");
               // deletefunction = "DeleteAttachment('" + this.option.data('img - src') + "')";
            }
          }
         
       // deleteImage = jQuery("<div class='tclose' onclick=" + deletefunction + ">X</div>");
        ...
        thumbnail.append(image);
          //deleteImage.append(image);
          //thumbnail.append(deleteImage);
