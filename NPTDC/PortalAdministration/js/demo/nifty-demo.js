...
$(document).on('nifty.ready', function () {
    ...
    $.get("../PortalAdministration/userInterfaces/moduleSystem/masterFiles/settings.aspx", function (data) {
    ...
    var settingsInit = function(){
        ...
        changeTheme = function (themeName, type) {
            var themeCSS = $('#theme'),
                fileext = '.min.css',
                filename = '../../../PortalAdministration/css/themes/type-' + type + '/' + themeName + fileext;
        ...
        $('#demo-theme').on('click', '.demo-theme', function (e) {
            ...
            changeTheme(el.attr('data-theme'), el.attr('data-type'));
                   $.cookie('theme', el.attr('data-theme'), { expires: 3000, path: '/' });
            $.cookie('theme-type', el.attr('data-type'), { expires: 3000, path: '/' });
        ...
        if ($.cookie('theme') != undefined) {
            changeTheme($.cookie('theme'), $.cookie('theme-type'));
        }
